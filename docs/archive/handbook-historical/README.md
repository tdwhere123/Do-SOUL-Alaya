# Handbook Historical Archive

Superseded handbook content. **Not current truth.**
...
| `workflow/agent-workflow-2026-07-full.md` | do-it skills |
| `workflow/subagent-dispatch.md` | do-it skills |
| `workflow/task-card-template.md` | `.do-it/plans/` or PR brief |
| `spikes/` | `.do-it/plans/` or archive copies here |
