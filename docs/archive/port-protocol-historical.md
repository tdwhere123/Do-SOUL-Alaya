# Port Protocol (Historical)

> **Status: archived after v0.1.0.** The vendor snapshot
> (`vendor/do-what-new-snapshot/`) was removed as part of the Phase E
...
This document defined the v0.1-specific Port-First discipline. It was
the single most important rule for Alaya v0.1 work and overrode any
