...
- **Write ownership:**
  ...
  - new directory `docs/bench-history/public-pre-v0.3.9/` for Pass A
    archives
  - `docs/archive/v0.3-historical/v0.3.9/reports/v0.3.9-bench-diff.md` (filled per
    category)
  - `docs/archive/v0.3-historical/v0.3.8/reports/v0.3.8-closeout.md` retroactive truth-up
- **Must verify:**
...
- **Write ownership:**
  ...
  - `docs/archive/v0.3-historical/v0.3.9/release-notes.md`
  - `docs/archive/v0.3-historical/v0.3.9/reports/v0.3.9-closeout.md`
...
1. `cat docs/archive/v0.3-historical/v0.3.9/plan.md` (this file).
