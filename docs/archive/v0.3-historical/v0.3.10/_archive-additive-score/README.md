...
- `docs/archive/v0.3-historical/v0.3.9/reports/v0.3.9-bench-diff.md` — bench regression evidence baseline
- `docs/archive/v0.3-historical/v0.3.9/reports/v0.3.9-closeout.md` — consolidated carry-forward (#1-#24) + Cat-H.3
- `docs/archive/v0.3-historical/v0.3.10/kpi-targets.md` K4.2 — Codex I1-I8 canonical tracker

若工作树未携带 `.do-it/findings/`，D0/D1/D2/D3 以仓库内可核对来源为准：
`docs/archive/v0.3-historical/v0.3.9/reports/v0.3.9-closeout.md`（24 carry-forward）+
`docs/archive/v0.3-historical/v0.3.10/kpi-targets.md` K4.2（I1-I8）。
...
- `docs/archive/v0.3-historical/v0.3.9/reports/v0.3.9-bench-diff.md` — bench 退化原始证据
- `docs/archive/v0.3-historical/v0.3.9/reports/v0.3.9-closeout.md` — 24 carry-forward 原始列表
