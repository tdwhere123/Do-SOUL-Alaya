...
- An external reader can re-run
  `node apps/bench-runner/bin/alaya-bench-runner.mjs longmemeval --variant s`
  and `node apps/bench-runner/bin/alaya-bench-runner.mjs locomo`
  to reproduce the tracked public archive shape after `pnpm build`.
...
- Writer: `node apps/bench-runner/bin/alaya-bench-runner.mjs live`
...
node apps/bench-runner/bin/alaya-bench-runner.mjs fetch-longmemeval --variant oracle --data-dir <shared-cache>/longmemeval
node apps/bench-runner/bin/alaya-bench-runner.mjs fetch-longmemeval --variant s --data-dir <shared-cache>/longmemeval
node apps/bench-runner/bin/alaya-bench-runner.mjs fetch-locomo --data-dir <shared-cache>/locomo
# If a checksum mismatch proves the cache bytes are stale/corrupt:
node apps/bench-runner/bin/alaya-bench-runner.mjs fetch-longmemeval --variant s --data-dir <shared-cache>/longmemeval --force
...
node apps/bench-runner/bin/alaya-bench-runner.mjs longmemeval --variant s --data-dir <shared-cache>/longmemeval
node apps/bench-runner/bin/alaya-bench-runner.mjs locomo --data-dir <shared-cache>/locomo
...
node apps/bench-runner/bin/alaya-bench-runner.mjs longmemeval --variant s --embedding env --data-dir <shared-cache>/longmemeval
node apps/bench-runner/bin/alaya-bench-runner.mjs locomo --embedding env --embedding-provider local_onnx --data-dir <shared-cache>/locomo
...
#    run artifacts.
node apps/bench-runner/bin/alaya-bench-runner.mjs live --source <local-main-check.json>
```
