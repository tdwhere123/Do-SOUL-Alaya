...
- ✓ LongMemEval-S embedding-100 must target: 68.00% >= target 60.00%

## Δ vs previous

| KPI | previous | current | delta | verdict |
|---|---|---|---|---|
| r_at_5 | 0.6600 | 0.6800 | +0.0200 | ✓ OK |
| r_at_10 | 0.6800 | 0.7100 | +0.0300 | ✓ OK |
| token_saved_ratio_vs_full_prompt | 0.0000 | 0.0000 | 0 | ✓ OK |
| latency_ms_p95 | 107.0000 | 2573.0000 | +2466.0000 | ✗ FAIL |

## Absolute KPIs

- R@1: 43.00% (95% CI ±9.53pp, [33.73%, 52.78%])
- R@5: 68.00% (95% CI ±9.00pp, [58.34%, 76.33%])
- R@10: 71.00% (95% CI ±8.76pp, [61.46%, 78.99%])
- Env embedding R@5 overall: 68.00%
- Env embedding R@5 when provider returned: 57.58%
- Latency p50: 109 ms (≤ worst-shard upper bound)
- Latency p95: 2573 ms (≤ worst-shard upper bound)
...
- Embedding provider states: returned=33.00% pending=0.00% failed=2.00%
