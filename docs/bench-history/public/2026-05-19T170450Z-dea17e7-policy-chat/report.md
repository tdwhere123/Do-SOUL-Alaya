...
- ✓ recall_p95_embedding_off recall p95 embedding-off: 141ms <= target 200ms

## Δ vs previous

| KPI | previous | current | delta | verdict |
|---|---|---|---|---|
| r_at_5 | 0.7400 | 0.7400 | 0 | ✓ OK |
| r_at_10 | 0.8200 | 0.8200 | 0 | ✓ OK |
| token_saved_ratio_vs_full_prompt | 0.0000 | 0.0000 | 0 | ✓ OK |
| latency_ms_p95 | 139.0000 | 141.0000 | +2.0000 | ✓ OK |
