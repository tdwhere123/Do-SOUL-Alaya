...
|---|---|---|---|---|
| r_at_5 | 0.0000 | 0.1700 | +0.1700 | ✓ OK |
| r_at_10 | 0.5000 | 0.6600 | +0.1600 | ✓ OK |
| token_saved_ratio_vs_full_prompt | 0.0000 | 0.0000 | 0 | ✓ OK |
| latency_ms_p95 | 114.0000 | 1049.0000 | +935.0000 | ⚠ WARN |

## Absolute KPIs

- R@1: 14.00% (95% CI ±6.81pp, [8.53%, 22.14%])
- R@5: 17.00% (95% CI ±7.33pp, [10.89%, 25.55%])
- R@10: 66.00% (95% CI ±9.13pp, [56.28%, 74.54%])
- Env embedding R@5 overall: 17.00%
- Env embedding R@5 when provider returned: 64.00%
- Latency p50: 82 ms
- Latency p95: 1049 ms
- Token saved vs full-prompt baseline: 0.00%
- Tier distribution: hot=25 warm=75 cold=0
- Degradation reasons: none=100 warm_cascade=0 cold_cascade=0 explainability_partial=0
- Embedding provider states: returned=25.00% pending=0.00% failed=0.00%
