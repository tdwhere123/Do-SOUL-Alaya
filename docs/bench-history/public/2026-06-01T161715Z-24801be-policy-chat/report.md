...
- Run at: 2026-06-01T16:17:15.684Z
...
- ✗ longmemeval_s_budget_dropped_max_entries budget_dropped_entries: 20 > target 8
...
- ✗ recall_p95_embedding_off recall p95 embedding-off: 1148.549705ms > target 200ms
...
- R@1: 55.00% (95% CI ±9.57pp, [45.24%, 64.39%])
- R@5: 81.00% (95% CI ±7.63pp, [72.22%, 87.49%])
- R@10: 84.00% (95% CI ±7.16pp, [75.58%, 89.90%])
- Latency p50: 661.812819 ms
- Latency p95: 1148.549705 ms
- Token saved vs full-prompt baseline: 100.00%
- Per-recall token economy (100 calls, measure-only):
  - delivered_context_tokens: mean=485.5 p50=483.0 p95=543.3 max=572
  - coarse_pool_size: mean=744.0 p50=740.0 p95=903.8 max=1066
  - fine_evaluated: mean=744.0 p50=740.0 p95=903.8 max=1066
...
- Quality metrics: non_monotonic=0.00% (0/100) budget_drop_loss=4 budget_dropped_entries=20 candidate_absent=0 no_gold=0 evidence_gold=100.00% path_top10=44.90%
