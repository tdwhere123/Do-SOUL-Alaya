...
Run 24801be on 2026-06-01T16:17:15.684Z is below one or more absolute benchmark targets.

## Release hard gate gaps

- **longmemeval_s_budget_dropped_max_entries budget_dropped_entries**: current 20 > target 8
- **recall_p95_embedding_off recall p95 embedding-off**: current 1148.549705ms > target 200ms
