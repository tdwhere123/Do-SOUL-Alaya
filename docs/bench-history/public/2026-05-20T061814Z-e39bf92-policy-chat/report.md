...
- ✓ recall_p95_embedding_off recall p95 embedding-off: 143ms <= target 200ms

## Δ vs previous

| KPI | previous | current | delta | verdict |
|---|---|---|---|---|
| r_at_5 | 0.7200 | 0.7200 | 0 | ✓ OK |
| r_at_10 | 0.8200 | 0.8200 | 0 | ✓ OK |
| token_saved_ratio_vs_full_prompt | 0.0000 | 0.0000 | 0 | ✓ OK |
| latency_ms_p95 | 168.0000 | 143.0000 | -25.0000 | ✓ OK |
