...
- Run at: 2026-06-01T13:32:07.418Z
...
Release hard gates:
- ✓ longmemeval_s_100_embedding_on_r_at_5 LongMemEval-S 100 embedding-on R@5: 84.00% >= target 55.00%
...
- ✗ longmemeval_s_budget_dropped_max_entries budget_dropped_entries: 26 > target 8
...
- ✗ recall_p95_embedding_on recall p95 embedding-on: 1789.836621ms > target 1100ms
...
- R@1: 62.00% (95% CI ±9.35pp, [52.21%, 70.90%])
- R@5: 84.00% (95% CI ±7.16pp, [75.58%, 89.90%])
- R@10: 85.00% (95% CI ±6.99pp, [76.72%, 90.69%])
- Env embedding R@5 overall: 84.00%
- Env embedding R@5 when provider returned: 84.00%
- Latency p50: 972.55112 ms
- Latency p95: 1789.836621 ms
- Token saved vs full-prompt baseline: 100.00%
- Per-recall token economy (100 calls, measure-only):
  - delivered_context_tokens: mean=482.2 p50=479.0 p95=532.3 max=588
  - coarse_pool_size: mean=843.6 p50=837.0 p95=1002.8 max=1165
  - fine_evaluated: mean=843.6 p50=837.0 p95=1002.8 max=1165
  - fusion_streams_with_hits: mean=13.2 p50=13.0 p95=14.0 max=14
...
- Quality metrics: non_monotonic=0.00% (0/100) budget_drop_loss=5 budget_dropped_entries=26 candidate_absent=0 no_gold=0 evidence_gold=100.00% path_top10=43.40%
- Abstention (calibrated confidence, threshold=0.91): 6 questions, correct@1=1 correct@5=1 correct@10=1; these correct-at-k counts are credited to the recall@k numerator (denominator unchanged).
