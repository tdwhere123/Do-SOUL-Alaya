...
Release hard gates:
- ✓ longmemeval_s_500_embedding_off_r_at_5 LongMemEval-S 500 embedding-off R@5: 65.60% >= target 65.00%
...
- ✓ longmemeval_s_candidate_absent candidate_absent: 5 <= target 6
- ✓ longmemeval_s_evidence_stream_gold_delivery evidence stream gold delivery: 100.00% >= target 15.00%
- ✓ recall_p95_embedding_off recall p95 embedding-off: 172ms <= target 200ms

## Δ vs previous

| KPI | previous | current | delta | verdict |
|---|---|---|---|---|
| r_at_5 | 0.6480 | 0.6560 | +0.0080 | ✓ OK |
| r_at_10 | 0.7800 | 0.7760 | -0.0040 | ✓ OK |
| token_saved_ratio_vs_full_prompt | 0.0000 | 0.0000 | 0 | ✓ OK |
| latency_ms_p95 | 180.0000 | 172.0000 | -8.0000 | ✓ OK |

## Absolute KPIs

- R@1: 31.40% (95% CI ±4.06pp, [27.49%, 35.60%])
- R@5: 65.60% (95% CI ±4.15pp, [61.33%, 69.63%])
...
- Quality metrics: non_monotonic=0.00% (0/500) budget_drop_loss=0 budget_dropped_entries=0 candidate_absent=5 no_gold=21 evidence_gold=100.00% path_top10=0.00%
