...
Release hard gates:
- ✓ longmemeval_s_500_embedding_off_r_at_5 LongMemEval-S 500 embedding-off R@5: 65.80% >= target 65.00%
...
- ✓ recall_p95_embedding_off recall p95 embedding-off: 188ms <= target 200ms

## Δ vs previous

| KPI | previous | current | delta | verdict |
|---|---|---|---|---|
| r_at_5 | 0.7200 | 0.6580 | -0.0620 | ✗ FAIL |
| r_at_10 | 0.8200 | 0.7760 | -0.0440 | ⚠ WARN |
| token_saved_ratio_vs_full_prompt | 0.0000 | 0.0000 | 0 | ✓ OK |
| latency_ms_p95 | 143.0000 | 188.0000 | +45.0000 | ⚠ WARN |

## Absolute KPIs

- R@1: 31.60% (95% CI ±4.06pp, [27.68%, 35.80%])
- R@5: 65.80% (95% CI ±4.14pp, [61.54%, 69.82%])
- R@10: 77.60% (95% CI ±3.65pp, [73.74%, 81.04%])
- Latency p50: 115 ms
- Latency p95: 188 ms
...
- Quality metrics: non_monotonic=0.00% (0/500) budget_drop_loss=0 budget_dropped_entries=0 candidate_absent=6 no_gold=21 evidence_gold=100.00% path_top10=0.00%
