...
Release hard gates:
- ✗ longmemeval_s_500_embedding_off_r_at_5 LongMemEval-S 500 embedding-off R@5: 64.20% < target 65.00%
...
|---|---|---|---|---|
| r_at_5 | 0.7400 | 0.6420 | -0.0980 | ✗ FAIL |
| r_at_10 | 0.8200 | 0.7760 | -0.0440 | ⚠ WARN |
| token_saved_ratio_vs_full_prompt | 0.0000 | 0.0000 | 0 | ✓ OK |
| latency_ms_p95 | 141.0000 | 165.0000 | +24.0000 | ✓ OK |

## Absolute KPIs

- R@1: 28.00% (95% CI ±3.92pp, [24.24%, 32.09%])
- R@5: 64.20% (95% CI ±4.19pp, [59.90%, 68.28%])
