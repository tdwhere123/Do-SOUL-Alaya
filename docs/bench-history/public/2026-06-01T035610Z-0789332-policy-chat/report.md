...
- ✗ longmemeval_s_budget_dropped_max_entries budget_dropped_entries: 21 > target 8
...
- ✗ recall_p95_embedding_off recall p95 embedding-off: 1274.081131ms > target 200ms
...
- Latency p50: 688.845892 ms
- Latency p95: 1274.081131 ms
- Token saved vs full-prompt baseline: 100.00%
- Per-recall token economy (100 calls, measure-only):
  - delivered_context_tokens: mean=485.3 p50=483.0 p95=543.3 max=572
  - coarse_pool_size: mean=744.0 p50=736.5 p95=902.7 max=1066
  - fine_evaluated: mean=744.0 p50=736.5 p95=902.7 max=1066
...
- Quality metrics: non_monotonic=0.00% (0/100) budget_drop_loss=4 budget_dropped_entries=21 candidate_absent=0 no_gold=0 evidence_gold=100.00% path_top10=44.80%
