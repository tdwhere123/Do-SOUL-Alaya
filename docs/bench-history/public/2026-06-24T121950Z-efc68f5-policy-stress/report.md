...
- Run at: 2026-06-24T12:19:50.979Z
...
Release hard gates:
- ✗ longmemeval_s_500_embedding_off_r_at_5 LongMemEval-S 500 embedding-off R@5: 77.00% < target 90.00%
- ✓ longmemeval_s_non_monotonic_rate non_monotonic_rate: 0.00% <= target 10.00%
- ✗ longmemeval_s_budget_dropped_max_entries budget_dropped_entries: 154 > target 8
...
- ✗ recall_p95_embedding_off recall p95 embedding-off: 1015.236992ms > target 200ms
...
- R@1: 51.20% (95% CI ±4.36pp, [46.83%, 55.56%])
- R@5: 77.00% (95% CI ±3.68pp, [73.11%, 80.47%])
- R@10: 84.60% (95% CI ±3.16pp, [81.17%, 87.50%])
- Latency p50: 618.572092 ms
- Latency p95: 1015.236992 ms
- Token saved vs full-prompt baseline: 100.00%
- Per-recall token economy (500 calls, measure-only):
  - delivered_context_tokens: mean=424.7 p50=408.0 p95=720.1 max=1007
  - coarse_pool_size: mean=398.9 p50=370.0 p95=609.0 max=721
  - fine_evaluated: mean=398.9 p50=370.0 p95=609.0 max=721
  - fusion_streams_with_hits: mean=12.6 p50=13.0 p95=14.0 max=14
...
- Quality metrics: non_monotonic=0.00% (0/500) budget_drop_loss=23 budget_dropped_entries=154 candidate_absent=1 no_gold=7 evidence_gold=100.00% path_top10=94.50%
- Abstention (calibrated confidence, threshold=0.91): 30 questions, correct@1=28 correct@5=24 correct@10=24; these correct-at-k counts are credited to the recall@k numerator (denominator unchanged).
