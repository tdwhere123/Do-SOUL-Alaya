...
Release hard gates:
- ✓ longmemeval_s_100_embedding_off_r_at_5 LongMemEval-S 100 embedding-off R@5: 74.00% >= target 70.00%
...
- ✓ recall_p95_embedding_off recall p95 embedding-off: 139ms <= target 200ms

## Δ vs previous

| KPI | previous | current | delta | verdict |
|---|---|---|---|---|
| r_at_5 | 0.7300 | 0.7400 | +0.0100 | ✓ OK |
| r_at_10 | 0.8200 | 0.8200 | 0 | ✓ OK |
| token_saved_ratio_vs_full_prompt | 0.0000 | 0.0000 | 0 | ✓ OK |
| latency_ms_p95 | 148.0000 | 139.0000 | -9.0000 | ✓ OK |

## Absolute KPIs

- R@1: 29.00% (95% CI ±8.76pp, [21.01%, 38.54%])
- R@5: 74.00% (95% CI ±8.48pp, [64.63%, 81.60%])
