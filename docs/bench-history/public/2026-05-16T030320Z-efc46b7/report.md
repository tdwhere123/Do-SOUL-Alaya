...
| latency_ms_p95 | 143.0000 | 1131.0000 | +988.0000 | ✗ FAIL |

## Absolute KPIs

- R@1: 59.00% (95% CI ±9.47pp, [49.20%, 68.13%])
- R@5: 77.00% (95% CI ±8.16pp, [67.85%, 84.16%])
- R@10: 80.00% (95% CI ±7.77pp, [71.12%, 86.66%])
- Env embedding R@5 overall: 77.00%
- Env embedding R@5 when provider returned: 80.95%
- Latency p50: 69 ms
- Latency p95: 1131 ms
...
- Embedding provider states: returned=21.00% pending=0.00% failed=0.00%
