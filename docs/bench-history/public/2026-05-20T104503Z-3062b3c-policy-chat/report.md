...
- Run at: 2026-05-20T10:45:03.672Z
...
Release hard gates:
- ✓ longmemeval_s_100_embedding_on_r_at_5 LongMemEval-S 100 embedding-on R@5: 73.00% >= target 55.00%
...
- ✓ recall_p95_embedding_on recall p95 embedding-on: 321ms <= target 1100ms

## Δ vs previous

| KPI | previous | current | delta | verdict |
|---|---|---|---|---|
| r_at_5 | 0.8000 | 0.7300 | -0.0700 | ⚠ WARN |
| r_at_10 | 0.9000 | 0.8300 | -0.0700 | ⚠ WARN |
| token_saved_ratio_vs_full_prompt | 0.0000 | 0.0000 | 0 | ✓ OK |
| latency_ms_p95 | 287.0000 | 321.0000 | +34.0000 | ✓ OK |

## Absolute KPIs

- R@1: 40.00% (95% CI ±9.43pp, [30.94%, 49.80%])
- R@5: 73.00% (95% CI ±8.58pp, [63.57%, 80.73%])
- R@10: 83.00% (95% CI ±7.33pp, [74.45%, 89.11%])
- Env embedding R@5 overall: 73.00%
- Env embedding R@5 when provider returned: 73.00%
- Latency p50: 174 ms
- Latency p95: 321 ms
