...
- Run at: 2026-05-19T19:52:36.928Z
...
Release hard gates:
- ✓ longmemeval_s_100_embedding_off_r_at_5 LongMemEval-S 100 embedding-off R@5: 72.00% >= target 70.00%
...
- ✓ recall_p95_embedding_off recall p95 embedding-off: 168ms <= target 200ms

## Δ vs previous

| KPI | previous | current | delta | verdict |
|---|---|---|---|---|
| r_at_5 | 0.6560 | 0.7200 | +0.0640 | ✓ OK |
| r_at_10 | 0.7760 | 0.8200 | +0.0440 | ✓ OK |
| token_saved_ratio_vs_full_prompt | 0.0000 | 0.0000 | 0 | ✓ OK |
| latency_ms_p95 | 172.0000 | 168.0000 | -4.0000 | ✓ OK |

## Absolute KPIs

- R@1: 35.00% (95% CI ±9.19pp, [26.36%, 44.75%])
