...
- ✗ longmemeval_s_budget_dropped_max_entries budget_dropped_entries: 139 > target 8
- ✓ longmemeval_s_candidate_absent candidate_absent: 3 <= target 6
- ✓ longmemeval_s_evidence_stream_gold_delivery evidence stream gold delivery: 100.00% >= target 15.00%
- ✗ recall_p95_embedding_off recall p95 embedding-off: 310.958532ms > target 200ms
...
- R@1: 49.40% (95% CI ±4.37pp, [45.04%, 53.77%])
- R@5: 81.60% (95% CI ±3.39pp, [77.97%, 84.75%])
- R@10: 84.20% (95% CI ±3.20pp, [80.74%, 87.13%])
- Latency p50: 199.289784 ms
- Latency p95: 310.958532 ms
...
- Seed truncation: turns=20 answer_bearing=0 chars_clipped=114892
- Seed extraction path: official_api_compile (cache_hits=124366 llm_calls=0 offline_fallbacks=0 live_failures=0 cached_failures=0 facts=321461 signals_dropped=36082 [parse_dropped=1692 compile_overflow_dropped=0 candidate_absent=33855 materialization_error=535])
  - ⚠ 36082 extracted signal(s) were lost before seeding (1692 dropped by the parser as malformed / over the 64-signal cap, 0 dropped by compile() as oversized, 34390 dropped when a seed-materialization batch failed); a dropped answer-bearing signal inflates the miss rate.
- Quality metrics: non_monotonic=0.00% (0/500) budget_drop_loss=17 budget_dropped_entries=139 candidate_absent=3 no_gold=5 evidence_gold=100.00% path_top10=61.12%
