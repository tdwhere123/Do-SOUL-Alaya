...
- `docs/v0.3/v0.3.9/reports/v0.3.9-closeout.md`（carry-forward/KPI 语义上下文）
- `docs/v0.3/v0.3.9/reports/v0.3.9-bench-diff.md`（bench 口径与回归背景）
- `docs/v0.3/v0.3.10/kpi-targets.md` K4.2（v0.3.10 KPI 身份与闭合口径）
...
- `docs/v0.3/v0.3.9/reports/v0.3.9-closeout.md`（carry-forward #1-#24 与 D 类问题基线）
- `docs/v0.3/v0.3.9/reports/v0.3.9-bench-diff.md`（bench regression 叙事主证据）
- `docs/v0.3/v0.3.10/kpi-targets.md` K4.2（I-series 闭合与 D0 映射口径）
...
`packages/core/src/recall-service.ts:2181-2194`, and this decision chooses the
...
- Repo-stable current implementation:
  `packages/core/src/recall-service.ts:2181-2194`
