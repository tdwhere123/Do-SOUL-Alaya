...
> - `docs/v0.3/v0.3.9/reports/v0.3.9-bench-diff.md` — regression baseline
> - `docs/v0.3/v0.3.9/reports/v0.3.9-closeout.md` — 24 carry-forward + Cat-H.3
...
- Phase 3 决策：保持 5 个兼容 runtime surface，概念上收敛为 4 个
  ...
  `docs/v0.3/v0.3.10/decisions.md` D15。
...
Phase 3 决策：采用 **G2a**；见
`docs/v0.3/v0.3.10/decisions.md` D14。
...
|---|---|---|---|
| #1 `derivePrecedenceBasis` canonical home | D1 | `rtk rg -n "derivePrecedenceBasis|see also:" packages/core packages/soul docs/handbook` | `docs/v0.3/v0.3.9/reports/v0.3.9-closeout.md` §Consolidated carry-forward |
| #2 `raw_payload.user_override` producer gap | D1 | `rtk rg -n "raw_payload\\.user_override|user_override" packages apps docs` | `docs/v0.3/v0.3.9/reports/v0.3.9-closeout.md` §Consolidated carry-forward |
| #3 stale prose (plan §L1-A line 256) | D1 | `rtk rg -n "memory_and_claim_draft|routeByObjectKind|claim-capable" docs packages` | `docs/v0.3/v0.3.9/reports/v0.3.9-closeout.md` §Consolidated carry-forward |
...
- carry-forward #1-#24: `docs/v0.3/v0.3.9/reports/v0.3.9-closeout.md` §Consolidated carry-forward
- Codex I1-I8: `docs/v0.3/v0.3.10/kpi-targets.md` K4.2 table
...
- #1 `derivePrecedenceBasis`：在 D0 matrix 里绑定 owner + verify 命令；
  ...
  `docs/v0.3/v0.3.9/reports/v0.3.9-closeout.md` §Consolidated carry-forward。
...
- 本阶段先统一可见 truth 文档中的 `UpgradeAssessmentAxis` 口径为
  ...
  `docs/v0.3/v0.3.9/reports/v0.3.9-closeout.md` §Cat-H.3
...
### Target
- 新 `docs/v0.3/v0.3.10/release-notes.md`
...
- `.do-it/findings/v0.3.10/_drafts/handbook-archaeology.md` — 本地补充考古材料
  （可缺失）
- `docs/v0.3/v0.3.9/reports/v0.3.9-bench-diff.md` — 退化原始证据
- `docs/v0.3/v0.3.9/reports/v0.3.9-closeout.md` — 24 carry-forward 完整列表
