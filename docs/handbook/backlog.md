...
**Close condition**: split the listed units under the SRP thresholds in `CLAUDE.md`, preserve package dependency direction, and pass focused regression tests for each moved owner.
