...
| EmbeddingRecallService | `implementation-ready`; package-root export remains `packages/core/src/index.ts`, implementation lives under `packages/core/src/embedding-recall/` | `live-event-ready` | P2-svc-embedding-recall |
