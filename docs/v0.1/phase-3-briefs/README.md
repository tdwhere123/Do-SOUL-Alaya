...
| P3-misc-services | Remaining support clusters: surface/workspace, policy/claims, graph, budget, dynamics, security status, slash discovery, prompt/node helpers. Foundation helpers are excluded and owned by `P3-misc-foundation`. | adapt-and-port | implementation-ready |
