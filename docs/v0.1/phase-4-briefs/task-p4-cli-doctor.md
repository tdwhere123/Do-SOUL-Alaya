# Implementation Brief: Task P4-cli-doctor — Implement alaya doctor

> - **Phase**: 4
> - **Wave**: 4
> - **Card ID**: P4-cli-doctor
> - **Port mode**: requires-redesign
> - **Source**: `n/a`
> - **Target**: `apps/core-daemon/src/cli/doctor.ts`, `apps/core-daemon/src/__tests__/cli-doctor.test.ts`
> - **Size**: M
...
`docs/v0.1/phase-4-briefs/README.md` row "P4-cli-doctor";
...
**Goal**: Deliver implement alaya doctor.
...
|---|---|---|
| `n/a` | `apps/core-daemon/src/cli/doctor.ts` | Alaya-specific redesign; tests must prove each behavior listed below. |
| `n/a` | `apps/core-daemon/src/__tests__/cli-doctor.test.ts` | Alaya-specific redesign; tests must prove each behavior listed below. |
...
| AC4 | Relevant targeted tests pass | `rtk pnpm exec vitest run --project @do-soul/alaya-core-daemon -t "cli doctor"` |
| AC5 | Completion report captures source files, port mode, verification, deviations, and deferrals | `docs/v0.1/phase-4-briefs/reports/task-p4-cli-doctor.md` exists and cites backlog issues for any deferred scope |
...
5. `rtk pnpm exec vitest run --project @do-soul/alaya-core-daemon -t "cli doctor"`
