# Implementation Brief: Task P4-routes-soul — Port daemon soul route batch

> - **Phase**: 4
> - **Wave**: 4
> - **Card ID**: P4-routes-soul
> - **Port mode**: adapt-and-port
> - **Source**: `vendor/do-what-new-snapshot/apps/core-daemon/src/routes/soul.ts`, `vendor/do-what-new-snapshot/apps/core-daemon/src/routes/soul-graph.ts`, `vendor/do-what-new-snapshot/apps/core-daemon/src/routes/garden-backlog.ts`, `vendor/do-what-new-snapshot/apps/core-daemon/src/routes/embedding-status.ts`, `vendor/do-what-new-snapshot/apps/core-daemon/src/routes/slots.ts`
> - **Target**: `apps/core-daemon/src/routes/soul.ts`, `apps/core-daemon/src/routes/soul-graph.ts`, `apps/core-daemon/src/routes/garden-backlog.ts`, `apps/core-daemon/src/routes/embedding-status.ts`, `apps/core-daemon/src/routes/slots.ts`
> - **Size**: M
...
`docs/v0.1/phase-4-briefs/README.md` row "P4-routes-soul";
...
**Goal**: Deliver port daemon soul route batch.
...
|---|---|---|
| `vendor/do-what-new-snapshot/apps/core-daemon/src/routes/soul.ts` | `apps/core-daemon/src/routes/soul.ts` | Port source behavior and apply only the adapter points listed below. |
| `vendor/do-what-new-snapshot/apps/core-daemon/src/routes/soul-graph.ts` | `apps/core-daemon/src/routes/soul-graph.ts` | Port source behavior and apply only the adapter points listed below. |
| `vendor/do-what-new-snapshot/apps/core-daemon/src/routes/garden-backlog.ts` | `apps/core-daemon/src/routes/garden-backlog.ts` | Port source behavior and apply only the adapter points listed below. |
| `vendor/do-what-new-snapshot/apps/core-daemon/src/routes/embedding-status.ts` | `apps/core-daemon/src/routes/embedding-status.ts` | Port source behavior and apply only the adapter points listed below. |
| `vendor/do-what-new-snapshot/apps/core-daemon/src/routes/slots.ts` | `apps/core-daemon/src/routes/slots.ts` | Port source behavior and apply only the adapter points listed below. |
...
| AC2 | Every source path cited by this card exists before dispatch | `rtk node -e "const fs=require('fs');const paths=[\"vendor/do-what-new-snapshot/apps/core-daemon/src/routes/soul.ts\",\"vendor/do-what-new-snapshot/apps/core-daemon/src/routes/soul-graph.ts\",\"vendor/do-what-new-snapshot/apps/core-daemon/src/routes/garden-backlog.ts\",\"vendor/do-what-new-snapshot/apps/core-daemon/src/routes/embedding-status.ts\",\"vendor/do-what-new-snapshot/apps/core-daemon/src/routes/slots.ts\"];const missing=paths.filter(p=>!fs.existsSync(p));if(missing.length){console.error(missing.join('\\n'));process.exit(1);}"` exits 0 |
