...
|---|---|---|
| `vendor/do-what-new-snapshot/packages/core/src/proposal-service.ts` | `packages/core/src/proposal-service.ts` | Copy first; only package-name/path rewrites are allowed. |
| `vendor/do-what-new-snapshot/packages/core/src/__tests__/proposal-service.test.ts` | `packages/core/src/__tests__/proposal-service.test.ts` | Copy first; only package-name/path rewrites are allowed. |
