# Implementation Brief: Task P2-garden-batch-4 — Port bootstrapping, remediation, and backlog telemetry Garden roles
...
`docs/v0.1/phase-2-briefs/README.md` row "P2-garden-batch-4";
...
**Goal**: Deliver port bootstrapping, remediation, and backlog telemetry Garden roles.
...
5. `rtk pnpm exec vitest run --project @do-soul/alaya-soul bootstrapping-service session-override-remediation backlog-telemetry`
