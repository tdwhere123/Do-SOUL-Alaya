...
|---|---|---|
| `vendor/do-what-new-snapshot/packages/core/src/green-service.ts` | `packages/core/src/green-service.ts` | Copy first; only package-name/path rewrites are allowed. |
| `vendor/do-what-new-snapshot/packages/core/src/__tests__/green-service.test.ts` | `packages/core/src/__tests__/green-service.test.ts` | Copy first; only package-name/path rewrites are allowed. |
