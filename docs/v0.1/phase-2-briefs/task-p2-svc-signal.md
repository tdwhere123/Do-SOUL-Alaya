...
|---|---|---|
| `vendor/do-what-new-snapshot/packages/core/src/signal-service.ts` | `packages/core/src/signal-service.ts` | Copy first; only package-name/path rewrites are allowed. |
| `vendor/do-what-new-snapshot/packages/core/src/__tests__/signal-service.test.ts` | `packages/core/src/__tests__/signal-service.test.ts` | Copy first; only package-name/path rewrites are allowed. |
