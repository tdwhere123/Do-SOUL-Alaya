...
function createRecordingConversationToolExecutor(toolSpec: ToolSpec): {
  ...
  readonly executor: ConversationToolExecutor;
  ...
  const substrate = new ToolSubstrate({
    generateExecutionId: () => "exec-affected-path",
  ...
  return {
    ...
    executor: new ConversationToolExecutor({
      ...
      now: () => "2026-04-20T00:00:01.000Z",
      generateExecutionId: () => "governance-affected-path"
    })
  };
}
