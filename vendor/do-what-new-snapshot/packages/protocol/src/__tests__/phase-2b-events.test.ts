...
describe("Phase 2B event schemas", () => {
  it("keeps Phase2BEventType enum complete and closed", () => {
    ...
    expect(Object.values(Phase2BEventType)).toEqual(expected);
    expect(Phase2BEventTypeSchema.options).toEqual(expected);
  });
  ...
  it("parses soul.surface.created payload", () => {
    ...
    expect(parsePhase2BEventPayload(Phase2BEventType.SOUL_SURFACE_CREATED, payload)).toEqual(payload);
  });
  ...
  it("parses soul.surface.status_changed payload", () => {
    ...
    expect(parsePhase2BEventPayload(Phase2BEventType.SOUL_SURFACE_STATUS_CHANGED, payload)).toEqual(payload);
  });
  ...
  it("parses soul.surface_anchor.created payload", () => {
    ...
    expect(parsePhase2BEventPayload(Phase2BEventType.SOUL_SURFACE_ANCHOR_CREATED, payload)).toEqual(payload);
  });
  ...
  it("parses soul.surface_anchor.deleted payload", () => {
    ...
    expect(parsePhase2BEventPayload(Phase2BEventType.SOUL_SURFACE_ANCHOR_DELETED, payload)).toEqual(payload);
  });
  ...
  it("parses soul.surface_binding.created payload", () => {
    ...
    expect(parsePhase2BEventPayload(Phase2BEventType.SOUL_SURFACE_BINDING_CREATED, payload)).toEqual(
      payload
    );
  });
  ...
  it("parses soul.surface_binding.state_changed payload", () => {
    ...
    expect(
      parsePhase2BEventPayload(Phase2BEventType.SOUL_SURFACE_BINDING_STATE_CHANGED, payload)
    ).toEqual(payload);
  });
  ...
  it("parses soul.cross_cutting.state_changed payload with null from_state", () => {
    ...
    expect(
      parsePhase2BEventPayload(Phase2BEventType.SOUL_CROSS_CUTTING_STATE_CHANGED, payload)
    ).toEqual(payload);
  });
  ...
  it("accepts phase-2b event types in EventType union", () => {
    expect(EventTypeSchema.parse(Phase2BEventType.SOUL_SURFACE_CREATED)).toBe(
      Phase2BEventType.SOUL_SURFACE_CREATED
    );
    expect(EventTypeSchema.parse(Phase2BEventType.SOUL_SURFACE_ANCHOR_DELETED)).toBe(
      Phase2BEventType.SOUL_SURFACE_ANCHOR_DELETED
    );
    expect(EventTypeSchema.parse(Phase2BEventType.SOUL_SURFACE_BINDING_STATE_CHANGED)).toBe(
      Phase2BEventType.SOUL_SURFACE_BINDING_STATE_CHANGED
    );
    expect(EventTypeSchema.parse(Phase2BEventType.SOUL_CROSS_CUTTING_STATE_CHANGED)).toBe(
