...
export interface BudgetBankruptcySseBroadcasterPort {
...
export interface BudgetBankruptcyServiceDependencies {
  ...
  readonly sseBroadcaster: BudgetBankruptcySseBroadcasterPort;
...
export class BudgetBankruptcyService {
  ...
  private async declareInternal(
    ...
    if (kind === BankruptcyKind.SOFT) {
      ...
      await this.dependencies.sseBroadcaster.broadcastEntry(declaredEvent);
      await this.dependencies.sseBroadcaster.broadcastEntry(resolvedEvent);
