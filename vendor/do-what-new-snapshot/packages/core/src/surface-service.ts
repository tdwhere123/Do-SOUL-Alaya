...
export interface SurfaceSseBroadcaster {
...
export interface SurfaceServiceDependencies {
  ...
  readonly sseBroadcaster: SurfaceSseBroadcaster;
...
export class SurfaceService {
  ...
  public async createSurface(input: {
    ...
    try {
      ...
      await this.dependencies.sseBroadcaster.broadcastEntry(created.event);
  ...
  public async transitionStatus(
    ...
    try {
      ...
      await this.dependencies.sseBroadcaster.broadcastEntry(updated.event);
  ...
  public async removeAnchor(anchorId: string, causedBy: string): Promise<void> {
    ...
    await this.dependencies.sseBroadcaster.broadcastEntry(deletedEvent);
  }
