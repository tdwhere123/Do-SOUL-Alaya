...
export interface MemorySseBroadcaster {
...
export interface MemoryServiceDependencies {
  ...
  readonly sseBroadcaster: MemorySseBroadcaster;
...
export class MemoryService {
  ...
  public async archive(
    ...
    await this.dependencies.sseBroadcaster.broadcastEntry(archivedEvent);
    await this.dependencies.sseBroadcaster.broadcastEntry(stateChangedEvent);
    return archived;
  }
