...
export type EdgeProposalCreateEventInput = Parameters<EdgeProposalRepoPort["create"]>[0];
...
export const ACCEPT_PATH_STRENGTH_FLOOR = 0.3;

export function edgeTypeToRecallBiasSign(edgeType: MemoryGraphEdgeTypeValue): 1 | 0 | -1 {
...
export const AUTO_ACCEPT_REVIEW_REASON = "auto-accepted by trigger floor policy";
...
export const TTL_EXPIRY_REVIEW_REASON = "auto-expired: pending proposal outlived its TTL with no review";
...
export const PATH_MINT_FAILED_REVIEW_REASON = "permanent path-anchor refusal on accept";
...
export const PATH_MINT_SUPERSEDED_REVIEW_REASON =
