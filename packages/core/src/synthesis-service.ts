...
// invariant: SynthesisCapsule keeps its synthesis-of-facts purpose. The
// promotion lifecycle (authority_round_count / cooldown_until /
// promotion_state and the three service methods that drove them) is
// retired because no live trigger existed — claim promotion now travels
// the inline soul.resolve / Proposal routes instead.
