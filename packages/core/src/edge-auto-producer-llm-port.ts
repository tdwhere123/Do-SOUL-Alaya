 ...
 * EdgeAutoProducerService, which converts an accepted verdict into a weak
 * attention_only PathRelation candidate submitted through the shared
 * PathCandidateSink (submitCandidate), carrying trigger_source =
 * "llm_supports" in the path's why provenance.
 *
 * Boundary discipline:
