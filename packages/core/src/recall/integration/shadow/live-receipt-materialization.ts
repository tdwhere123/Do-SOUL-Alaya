...
} from "../../decision/query-proof/live-query-proof-authority.js";
import type { ShadowIntegrateInput } from "./integrate.js";
import {
  lexicalIntervalSourceEnvelopes
} from "../../decision/query-proof/measurement/lexical-interval-envelope.js";
import {
...
} from "../../decision/query-proof/measurement/index.js";
import {
  materializeSupportFromReceipts,
  type SupportMaterializationV1
} from "../../decision/query-proof/support/index.js";
import {
