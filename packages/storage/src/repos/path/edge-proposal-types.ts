...
// see also: packages/core/src/relations/edge-proposals/edge-proposal-service.ts handleMintFailure.
...
export interface EdgeProposalRepo {
  ...
  // see also: packages/core/src/relations/edge-proposals/edge-proposal-service.ts sweepExpired
  ...
  // see also: packages/core/src/relations/edge-proposals/edge-proposal-service.ts reconcileStuckAccepts;
