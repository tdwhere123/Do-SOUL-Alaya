...
// see also: packages/core/src/relations/producers/path-candidate-sink.ts PathCandidateSink.
// see also: packages/core/src/relations/edge-proposals/path-relation-proposal-service.ts seed profiles.
...
// see also: packages/core/src/relations/edge-proposals/path-relation-proposal-service.ts PathMintOutcome.
