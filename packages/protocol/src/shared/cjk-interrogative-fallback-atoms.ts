...
const CJK_COPULAR_MEASURE_FORMS = cjkWhSurfaces(OPEN_SEMANTIC_DURATION_WH_SURFACES);
const CJK_LOCATION_RESULT_FORMS = cjkWhSurfaces(OPEN_SEMANTIC_LOCATION_WH_SURFACES);
const CJK_COPULAR_PREDICATE_FORMS = ["要", "是"] as const;
const CJK_LOCATIVE_LINKER_FORM = "在" as const;

const CJK_INTERROGATIVE_RESULT_FORMS = Object.freeze([
