...
export const ALAYA_MCP_SERVER_INSTRUCTIONS = [
  ...
  "On soul.report_context_usage, include turn_index and turn_digest.last_messages so Alaya can extract durable candidates from this turn. Ordinary soul.recall does not enqueue extraction; recent_turn is ignored.",
  "You MAY still call soul.emit_candidate_signal then soul.propose_memory_update for a fact you judge clearly worth recording explicitly.",
