...
const hoisted = vi.hoisted(() => {
  const conversationToolSpecs = [
    ...
    { tool_id: "tools.write_file", category: "write", description: "Write a file", scope_guard: "workspace", read_only: false, destructive: false, concurrency_safe: false, interrupt_behavior: "wait", requires_confirmation: true, requires_evidence_reopen: false, rollback_support: "best_effort", fast_path_eligible: false },
