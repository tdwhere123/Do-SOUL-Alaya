...
const bridgeDistPath = resolve(packageRoot, "dist/cli/bridge.js");
const registerDistPath = resolve(packageRoot, "dist/cli/register.js");
const daemonDistPath = resolve(packageRoot, "dist/index.js");
