...
vi.mock("../../longmemeval/seed-fuel-collector.js", () => ({
...
vi.mock("../../longmemeval/runner-question.js", () => ({
...
vi.mock("../../longmemeval/runner-helpers.js", () => ({
  writeRecallEvalSnapshot: mocks.writeSnapshot
}));
vi.mock("../../longmemeval/provenance/run.js", () => ({
  buildLongMemEvalRunProvenance: mocks.buildProvenance
}));
vi.mock("../../longmemeval/snapshot/current-substrate-authority.js", () => ({
