...
import { warmDocumentEmbeddingCaches } from "../../runs/embedding-warmup.js";
...
describe("warmDocumentEmbeddingCaches", () => {
  it("keeps the disabled arm free of embedding side effects", async () => {
    ...
    await expect(warmDocumentEmbeddingCaches({
