...
Usage:
  ...
  alaya-bench-runner recall-eval --snapshot <db> [--experiment [--rebuild-evidence-search-projections [--fact-frame-retrofit-ledger <ndjson> --seed-extraction-system-prompt <txt>]] | --promotion-contract <json> | --legacy-snapshot --legacy-manifest-sha256 <sha> --legacy-dataset-sha256 <sha>] [--variant oracle|s|m] [--limit N] [--offset N] [--policy-shape stress|chat] [--weights '<json>'] [--data-dir <path>] [--data-dir-root <path>] [--pinned-meta-root <path>] [--history-root <path>]
