...
import type { LongMemEvalSeedDropReasons } from "../runs/extraction/seed-fuel/seed-drop-reasons.js";
import { deriveQuestionMeasurementStatus } from
  "../runs/measurement/question-measurement-status.js";
...
export function deriveQuestionEvaluationIssueReason(input: {
  readonly isAbstention: boolean;
  readonly premiseInvalid: boolean;
  readonly goldMemoryIds: readonly string[];
  readonly goldEvidenceIds?: readonly string[];
