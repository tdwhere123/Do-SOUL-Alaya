 ...
 *
 * cross-file: apps/bench-runner/src/datasets/longmemeval/extraction-cache-manifest.ts
 */
export interface ExtractionCachePreflightInput {
  ...
  // cross-file: apps/bench-runner/src/datasets/longmemeval/extraction-fill.ts
