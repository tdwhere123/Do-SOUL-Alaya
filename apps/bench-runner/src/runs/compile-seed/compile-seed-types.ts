 ...
 * `KpiCore.seed_extraction_path`; the LongMemEval-S runner threads it
 * through this helper so a no_credentials_fallback run is never
 * indistinguishable from a real official_api_compile run in the archive.
 */
