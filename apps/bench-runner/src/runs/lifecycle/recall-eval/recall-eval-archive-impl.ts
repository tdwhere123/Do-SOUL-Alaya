 ...
 * see also: apps/bench-runner/src/datasets/longmemeval/recall-eval.ts (writes it)
 * see also: apps/bench-runner/src/datasets/longmemeval/runner.ts (full-run baseline)
 */
